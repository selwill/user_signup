...
def display_user_signup_form():
    return render_template('user-signup_main.html')
...
def user_signup_complete():
    ...
    if not username_error and not password_error and not password_validate_error and not email_error:
        ...
        return render_template('user-signup_main.html', username_error=username_error, username=username, password_error=password_error, password=password, password_validate_error=password_validate_error, password_validate=password_validate, email_error=email_error, email=email)


@app.route('/welcome')
def valid_signup():
    username = request.args.get('username')
    return render_template('user-signup_welcome.html', username=username)
